namespace Beltway.ExtractWarehouseId {
    ...
    public sealed class ProcedureResultSet_dbo_spExtractWarehouseid : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:ns3=""http://schemas.microsoft.com/Sql/2008/05/ProceduresResultSets/dbo/spExtractWarehouseid"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" elementFormDefault=""qualified"" targetNamespace=""http://schemas.microsoft.com/Sql/2008/05/ProceduresResultSets/dbo/spExtractWarehouseid"" version=""1.0"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:annotation>
    <xs:appinfo>
      <fileNameHint xmlns=""http://schemas.microsoft.com/servicemodel/adapters/metadata/xsd"">ProcedureResultSet.dbo.spExtractWarehouseid</fileNameHint>
    </xs:appinfo>
  </xs:annotation>
  <xs:complexType name=""StoredProcedureResultSet0"">
    <xs:sequence>
      <xs:element minOccurs=""0"" maxOccurs=""1"" name=""WarehouseId"" nillable=""true"" type=""xs:int"" />
    </xs:sequence>
  </xs:complexType>
  ...
  <xs:element name=""ArrayOfStoredProcedureResultSet0"" nillable=""true"" type=""ns3:ArrayOfStoredProcedureResultSet0"" />
        ...
        public ProcedureResultSet_dbo_spExtractWarehouseid() {
        }
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/ProceduresResultSets/dbo/spExtractWarehouseid",@"StoredProcedureResultSet0")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/ProceduresResultSets/dbo/spExtractWarehouseid",@"ArrayOfStoredProcedureResultSet0")]
        [System.SerializableAttribute()]
